...
export default function SmarikaAdsForm() {
    const emptyForm = {
        orgName: "",
        mobile: "",
        email: "",
    ...
    useEffect(() => {
        try {
            const saved = window.localStorage?.getItem("adsFormData");
            if (saved) {
    ...
    useEffect(() => {
        try {
            window.localStorage?.setItem("adsFormData", JSON.stringify(formData));
        } catch (error) {
            console.log("Storage not available");
        }
    }, [formData]);
                    ...
                    <div className="p-8">
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="विज्ञापन का विस्तृत विवरण दर्ज करें..."
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows="3"
                                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none resize-none"
                                        placeholder="मकान नं., गली, क्षेत्र..."
                                    />
                                </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6 border-t border-gray-200">
                            <button
                                ...
                                className="flex-1 sm:flex-none bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 focus:ring-4 focus:ring-indigo-300 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isSubmitting ? (
                            ...
                            <button
                                onClick={clearForm}
                                className="flex-1 sm:flex-none bg-white border-2 border-red-500 text-red-500 px-8 py-3 rounded-lg font-semibold hover:bg-red-50 focus:ring-4 focus:ring-red-200 transition-all"
                            >
                                <ListRestart />
                            </button>
                        </div>
